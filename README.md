...
data/processed/train\_clean.csv

data/processed/test\_clean.csv
...
\| \`ngram\_range\` | \`(1, 2)\` | Uses unigrams and bigrams |

\| \`min\_df\` | \`2\` | Removes extremely rare terms |

\| \`max\_df\` | \`0.95\` | Removes extremely common terms |
...
models/sentiment\_model.joblib
...
This trains the TF-IDF + Linear SVM pipeline and saves the trained model to `models/sentiment_model.joblib`.
